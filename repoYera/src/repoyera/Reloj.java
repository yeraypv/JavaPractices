...
public class Reloj extends JPanel implements ActionListener {
    ...
    private int iniHora=0,iniMin=0;

    /**
     * Constructor que hace una instancia de la clase tomando la hora del
     * sistema la instancia puede ser para la HORA UTC o la HORA LOCAL
     *
     * @param booUTC - true indica si se inicia el reloj en HORA UTC, false se
     * inicia el reloj en HORA LOCAL
     */
    ...
    /**
     * Constructor para crear una instancia del reloj pasandole la hora,
     * minutos, segundos y si esta hora sera mostrada en tiempo universal o
     * local
     *
     * @param iHoraLocal int, Hora Local
     * @param iMinutoLocal int, Miniutos local
     * @param iSegundoLocal int, Segundos
     * @param booUTC booleano, true para mostrar HORA UTC(HORA UNIVERSAL), false
    ...
    /**
     * Metodo el cual retona la fecha en formato largo (Ej. Miercoles, 6 Abril
     * 2004)
     *
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Calendar.getInstance().get(Calendar.SECOND) > 0) {
            ...
            if(iniMin == 1){
                RepoYera repo = new RepoYera();
                repo.copiasHora();
                lblFecha.setText("Creando Copia de seguridad del repositorio...");
                iniMin = 0;
            }
            if(iniHora == 1){
                RepoYera repo = new RepoYera();
                repo.copiasRegresiva();
                lblFecha.setText("Creando Copia regresiva del repositorio...");
                iniHora = 0;
            }
        }
     ...
     * ********************************************************************
     *
     * main de demostraci�n
     *
     ***************************************************************
     */
    public static void main(String[] args) {
        JFrame jf = new JFrame("RepoYera");
        ...
        jf.setContentPane(new Reloj(true));
        jf.setSize(280, 100);
        jf.setVisible(true);
